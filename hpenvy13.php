     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">HP Envy 13</h4>
               <h1 class="card-text">€700</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/hpenvy13.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Storage is good with 512 SSD<br>- Processor Intel Core i7-7500U (3.4GHz)Quad-core<br>- Display 15.6-inch FHD (1920 x 1080)<br>- Speakers
