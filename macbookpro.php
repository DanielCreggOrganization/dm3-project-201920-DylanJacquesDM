      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/macbook pro.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Storage is okay with 256 SSD<br>- Processor Intel Core i7-7500U (2.9GHz)Quad-core<br>- Display 15.6-inch FHD (1920 x 1080)<br>- Speakers
