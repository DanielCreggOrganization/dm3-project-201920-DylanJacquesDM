     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Canon SX70</h4>
               <h1 class="card-text">€1115</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/canon sx70.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- 18.7 million effective pixels quality<br>- LCD Monitor 990,000 dots<br>- High-speed continuous shots go to 9.3 fps<br>- Weight (No battery): 910 g (1.6.2 lb)<br>- Auto ISO 50 to 1800 for casual users</p>
