     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Motorolla G8 Plus</h4>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/motorollag8plus.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Smooth textured 6.3" Display<br>- Decent 16MP Front Camera<br>- Very middle of the road 4GB RAM on board<br>- Running the very reliable Android 9.0<br>- Very long lasting 4000mAh Battery Capacity</p>
...
<a class="btn btn-outline-primary btn-sm" role="button" href="Smartphones.php"><h4>Other Phones</h4></a>	
<br>
<br>
<br>
<br>
