     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Samsung Galaxy S10</h4>
               <h1 class="card-text">€750</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/galaxy s10.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Clean textured 6" Display<br>- Crisp 10mp Front Camera<br>- Whopping 8GB RAM on board<br>- Running Android 9.0 Pie Software<br>- Very reliable Battery Capacity
3400mAh</p>
