     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Microsoft Surfacebook 2</h4>
               <h1 class="card-text">€960</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/surfacebook.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Storage is okay with 256 SSD<br>- Processor Intel Core i5-7200U (2.9GHz)Dual-core<br>- Display 13.5-inch FHD (1920 x 1080)<br>- Speakers
Dolby Digital 3.0<br>- Battery
44Wh, so respectable life</p>
