     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Canon EOS 50</h4>
               <h1 class="card-text">€820</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/canno eos50.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- 15.0 million effective pixels quality<br>- LCD Monitor 920,000 dots<br>- High-speed continuous shots go to 6.3 fps<br>- Weight (No battery): 730 g (1.6 lb)<br>- Auto ISO 100 to 1600 for casual users</p>
...
<a class="btn btn-outline-primary btn-sm" role="button" href="digitalcameras.php"><h4>Other Cameras</h4></a>	
<br>
<br>
<br>
<br>
