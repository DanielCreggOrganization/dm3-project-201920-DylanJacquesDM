     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">huawei p30</h4>
               <h1 class="card-text">€920</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/huawei p30.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- Clean textured 6" Display<br>- Outstanding 32mp Front Camera<br>- Reasonable 8GB RAM on board<br>- Running Android 9.0 Pie Software<br>- Very impressive Battery Capacity
3400mAh</p>
