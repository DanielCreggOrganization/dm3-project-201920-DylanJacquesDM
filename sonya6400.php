     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Sony a6400</h4>
               <h1 class="card-text">€720</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/sonya6400.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- 15.7 million effective pixels quality<br>- LCD Monitor 910,000 dots<br>- High-speed continuous shots go to 6.3 fps<br>- Weight (No battery): 710 g (1.6.2 lb)<br>- Auto ISO 100 to 1600 for casual users</p>
