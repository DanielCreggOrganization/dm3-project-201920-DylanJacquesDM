    ...
    <div class="row">
     <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/canno eos50.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Canon EOS 50</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="canoneos50.php" class="btn btn-dark btn-sm">Click Here</a>
            </div>
         </div>
      </div>
      <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/Canon G7X.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Canon G7X</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="canong7x.php" class="btn btn-dark btn-sm">Click Here</a>
            </div>
         </div>
      </div>
       <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/lumix GH5.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Lumix GH5</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="lumixgh5.php" class="btn btn-dark btn-sm">Click Here</a>
         </div>
      </div>
	  </div>
	   <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/Canon sx400.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Canon SX400</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="canonsx400.php" class="btn btn-dark btn-sm">Click Here</a>
            </div>
         </div>
      </div>
	   <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/sonya6400.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Sony a6400</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="sonya6400.php" class="btn btn-dark btn-sm">Click Here</a>
            </div>
         </div>
      </div>
	   <div class="col-md-4">
         <div class="card mb-4 border-dark">
            <img class="card-img-top" src="img/productimages/canon sx70.jpg" alt="Card image cap">
            <div class="card-body">
               <h5 class="card-title">Canon SX70</h5>
               <p class="card-text">Click here to view the rating</p>
               <a href="canonsx70.php" class="btn btn-dark btn-sm">Click Here</a>
            </div>
         </div>
      </div>
   </div>
