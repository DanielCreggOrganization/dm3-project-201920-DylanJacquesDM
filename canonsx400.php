     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Canon SX400</h4>
               <h1 class="card-text">€690</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/Canon sx400.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- 12.5 million effective pixels quality<br>- LCD Monitor 780,000 dots<br>- High-speed continuous shots go to 6.1fps<br>- Weight (No battery): 660 g (1.6 lb)<br>- Auto ISO 100 to 1500 for casual users</p>
