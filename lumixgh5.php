     ...
     <div class="col-md-6">
         <div class="card mb-9 border-dark">
            ...
            <div class="card-body">
               ...
               <h4 class="card-title">Lumix GH5</h4>
               <h1 class="card-text">€790</h1>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="col-md-6">
		 ...
		 <img class="card-img-top" src="img/productimages/lumix GH5.jpg" alt="Card image cap">
            <div class="card-body d-flex flex-column align-items-start">
               ...
               <p class="card-text mb-auto">- 13.0 million effective pixels quality<br>- LCD Monitor 780,000 dots<br>- High-speed continuous shots go to 7.1fps<br>- Weight (No battery): 760 g (1.6 lb)<br>- Auto ISO 100 to 1600 for casual users</p>
